"""
Django settings for course_monitor project.
...
ROOT_URLCONF = 'course_monitor.urls'
...
WSGI_APPLICATION = 'course_monitor.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'USER': os.environ.get('RDS_USR'),
        'PASSWORD': os.environ.get('RDS_PWD'),
